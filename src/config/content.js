...
const flagItems = [
  { value: '🇫🇷', labels: { pl: 'Francja', en: 'France' } },
  { value: '🇪🇸', labels: { pl: 'Hiszpania', en: 'Spain' } },
  { value: '🇺🇸', labels: { pl: 'Stany Zjednoczone', en: 'United States' } },
  { value: '🇨🇳', labels: { pl: 'Chiny', en: 'China' } },
  { value: '🇮🇹', labels: { pl: 'Włochy', en: 'Italy' } },
  { value: '🇹🇷', labels: { pl: 'Turcja', en: 'Turkey' } },
  { value: '🇲🇽', labels: { pl: 'Meksyk', en: 'Mexico' } },
  { value: '🇩🇪', labels: { pl: 'Niemcy', en: 'Germany' } },
  { value: '🇹🇭', labels: { pl: 'Tajlandia', en: 'Thailand' } },
  { value: '🇬🇧', labels: { pl: 'Wielka Brytania', en: 'United Kingdom' } },
  { value: '🇯🇵', labels: { pl: 'Japonia', en: 'Japan' } },
  { value: '🇦🇹', labels: { pl: 'Austria', en: 'Austria' } },
  { value: '🇬🇷', labels: { pl: 'Grecja', en: 'Greece' } },
  { value: '🇲🇾', labels: { pl: 'Malezja', en: 'Malaysia' } },
  { value: '🇵🇹', labels: { pl: 'Portugalia', en: 'Portugal' } },
  { value: '🇳🇱', labels: { pl: 'Holandia', en: 'Netherlands' } },
  { value: '🇵🇱', labels: { pl: 'Polska', en: 'Poland' } },
  { value: '🇭🇷', labels: { pl: 'Chorwacja', en: 'Croatia' } },
  { value: '🇨🇭', labels: { pl: 'Szwajcaria', en: 'Switzerland' } },
  { value: '🇪🇬', labels: { pl: 'Egipt', en: 'Egypt' } },
  { value: '🇮🇩', labels: { pl: 'Indonezja', en: 'Indonesia' } },
  { value: '🇦🇪', labels: { pl: 'Zjednoczone Emiraty Arabskie', en: 'United Arab Emirates' } },
  { value: '🇰🇷', labels: { pl: 'Korea Południowa', en: 'South Korea' } },
  { value: '🇦🇺', labels: { pl: 'Australia', en: 'Australia' } },
  { value: '🇨🇦', labels: { pl: 'Kanada', en: 'Canada' } },
  { value: '🇧🇷', labels: { pl: 'Brazylia', en: 'Brazil' } },
  { value: '🇮🇳', labels: { pl: 'Indie', en: 'India' } },
  { value: '🇨🇿', labels: { pl: 'Czechy', en: 'Czech Republic' } },
  { value: '🇭🇺', labels: { pl: 'Węgry', en: 'Hungary' } },
  { value: '🇲🇦', labels: { pl: 'Maroko', en: 'Morocco' } },
  { value: '🇻🇳', labels: { pl: 'Wietnam', en: 'Vietnam' } },
  { value: '🇮🇪', labels: { pl: 'Irlandia', en: 'Ireland' } },
  { value: '🇸🇬', labels: { pl: 'Singapur', en: 'Singapore' } },
  { value: '🇧🇪', labels: { pl: 'Belgia', en: 'Belgium' } },
  { value: '🇩🇰', labels: { pl: 'Dania', en: 'Denmark' } },
  { value: '🇸🇪', labels: { pl: 'Szwecja', en: 'Sweden' } },
  { value: '🇳🇴', labels: { pl: 'Norwegia', en: 'Norway' } },
  { value: '🇮🇸', labels: { pl: 'Islandia', en: 'Iceland' } },
  { value: '🇳🇿', labels: { pl: 'Nowa Zelandia', en: 'New Zealand' } },
  { value: '🇿🇦', labels: { pl: 'Republika Południowej Afryki', en: 'South Africa' } },
];
